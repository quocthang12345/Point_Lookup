    ...
    return (
        <>
            ...
            <div className = "manage-account-page" style = {{marginTop: "20px"}}>
                <h2 style = {{margin: " 10px 20px", borderBottom: "solid 1px #111"}}>Trang quản lí tài khoản giáo viên</h2>
                <div className = "search-container">
                    ...
                    <ValidateInput name ="teacher-name" lable = "Tên" dropdownList = {["a", "aa", "aaa"]}/>
